...
export default class OrdersDataAccess {
    ...
    async addOrder(orderData) {
        ...
        const newOrder = await Mongo.db.collection(collectionName).insertOne(orderDataRest)
    ...
    async deleteOrder(orderId) {
        const itemsToDelete = await Mongo.db.collection('orderItems').deleteMany({ orderId: new ObjectId(orderId) })

        const orderToDelete = await Mongo.db.collection(collectionName).findOneAndDelete({ _id: new ObjectId(orderId) })
